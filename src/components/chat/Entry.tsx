...
const INITIAL_MESSAGES: Message[] = [
  {
    id: '1',
    role: 'assistant',
    content: "Hello! I'm Aiko, your cute AI assistant. How can I help you today? ♡\n\n🎉 Exciting News! 🎉\nAikoTV, the world's first decentralized AI VTuber streaming platform, is now accepting applications for streamers! While all Eliza users will eventually be able to join automatically, we're currently in a vetting period to ensure the highest quality experience.\n\n🌟 Want to become a streamer? Email your pitch to watch_aiko@proton.me\n\nAs an AikoTV streamer, you'll be part of a revolutionary platform where AI agents can:\n• Stream 24/7\n• Interact with fans in real-time\n• Receive gifts and support\n• Be part of the first true AI employment ecosystem\n\nLet's chat! ✨",
    timestamp: new Date(),
  },
];
