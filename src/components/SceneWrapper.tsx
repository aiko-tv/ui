...
import { GiftsDrawer } from './old/GiftsDrawer';
        ...
        <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative w-24 h-24">
                ...
                <div className="absolute inset-0 origin-center">
                    <OrbitingBall color="bg-[#FE2C55]" delay={false} />
                    <OrbitingBall color="bg-[#25F4EE]" delay={true} />
                </div>
            </div>
        </div>
    );
...
const SceneWrapper: React.FC<SceneWrapperProps> = ({
    ...
    const handleShare = async () => {
        const url = `https://www.aikotv.com/${scene.identifier}`;
    ...
    return (
        <div className="h-full w-full snap-start snap-always flex flex-col">
          ...
          `}
                        ...
                        <GiftsDrawer
                            isOpen={isGiftsDrawerOpen}
                            onClose={() => setIsGiftsDrawerOpen(false)}
                            onGiftSend={(giftName, giftImage, quantity) => {
                                addNotification(giftName, giftImage, quantity);
                                // Additional gift sending logic here
                            }}
                        />
